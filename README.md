...
- `docs/fabric-design.html` / `docs/fabric-design-ko.html` — the conductive-fabric v2 concept (English / Korean).
- `docs/fabric-test-materials.md` — parts to order to test the fabric sensor.
